##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.14.1] date: [Sat Sep 25 14:39:03 PDT 2021] 
##########################################################################################################################
...
C_SOURCES += _gpio.c _usart.c _tim.c _i2c.c led.c eeprom.c

# modules
VPATH += Core/modules/Src
C_SOURCES += worker.c queuemonitor.c system.c mem.c crtp.c
